  ...
  return (
    <article className="admin-card admin-section-card">
      ...
      <div className="admin-section-card__content">
        ...
        <small style={{ display: 'block', marginTop: 7, color: '#9aa4b5' }}>Quản lý Topic và Lesson theo cấu trúc của Section.</small>
      </div>
      <div className="admin-actions admin-section-card__actions">
        ...
        <Link className="admin-button admin-button--secondary admin-button--small" to={`/admin/sections/${section.id}/topics`}>Quản lý Topic</Link>
